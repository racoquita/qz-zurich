var App = function() {
	...
	this.off = function() {
		...
		$('.cta img:first-child').attr('src', 'http://ads.qz.com/sponsors/zurich/love/2014-05-15/tablet/images/cta.png');
	}
	this.loadVideo = function() {
		...
		$('.x').off().on('click', function(){
			...
			$('.cta img:first-child').attr('src', 'http://ads.qz.com/sponsors/zurich/love/2014-05-15/tablet/images/learn-more.png');
			that.unloadVideo();
		});
